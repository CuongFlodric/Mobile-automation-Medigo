...
First, upload the application you need to test.
...
Update app url in user.java and pharmacy.java.
cap.setCapability("app", "app url");

# To run test go to testng.xml in your IDE then run.
  The session report will show on BrowserStack dashboard.
